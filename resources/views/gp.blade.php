     ...
     <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Add Gp and Vendor</div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" name="gpform" id="gpform" role="form" method="POST" action="{{ url('/add_lot') }}">
                        ...
                        <div class="form-group">
                            <span for="vendorname" class="col-md-2 control-label">Vendor</span>
                        ...
                        <div class="form-group">
                            <span for="gp" class="col-md-2 control-label">GP</span>
                        ...
                        <div class="form-group">
                            <label for="received_at" class="col-md-2 control-label">Received At</label>
                        ...
                        <div class="form-group">
                            <div class="col-md-4 col-md-offset-4">
                                <button type="submit" class="btn btn-primary btnsub">
...
<div class="footer"><div class="container"><p>2017-2018 myntra. All Rights Reserved.</p></div></div>
 <script>

    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color:#A9A9A9;color:#006400">Add Lot Id's</div>
                ...
                <div class="panel-body">
					...
					<input type="hidden" class="form-control" name="token" id="token" value="{{csrf_token()}}" >
                        ...
                        <div class="form-group{{ $errors->has('gp_number') ? ' has-error' : '' }}">
                            <label for="gp_number" class="col-md-4 control-label">GP</label>
                        ...
                        <div class="form-group{{ $errors->has('lot_id') ? ' has-error' : '' }}">
                            <label for="lot_id-confirm" class="col-md-4 control-label">Lot ID</label>
		 ...
		 <div class="col-md-8 col-md-offset-2" id="gp_lot">

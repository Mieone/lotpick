...
class Lot_Locations extends Controller
{
    ...
    {						
        return view('lat_location',array('lotdata'=>$this->getdata_lot_first(),'count'=>count($this->getdata_lot_first_count()),'count_next'=>count($this->getdata_lot_first_count())));
    }
	public function pick_list()
	{
		return view('pick_list',array('lotdata'=>$this->getdata_pick()));
	}

    public function add_lat_location()
    {
         return view('add_lot_location');
    }
    /**
